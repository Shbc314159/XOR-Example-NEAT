...
{
    "distutils": {
        "name": "Neural_Network.__init__",
        "sources": [
            "Neural_Network\\__init__.py"
        ]
    },
    "module_name": "Neural_Network.__init__"
}
END: Cython Metadata */
...
#define __PYX_HAVE__Neural_Network
#define __PYX_HAVE_API__Neural_Network
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "Neural_Network" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "Neural_Network.__init__"
extern int __pyx_module_is_main_Neural_Network____init__;
int __pyx_module_is_main_Neural_Network____init__ = 0;
...
#define __pyx_kp_u_Neural_Network___init __pyx_string_tab[1]
...
__Pyx_PyMODINIT_FUNC PyInit___init__(void) { return PyInit_Neural_Network(); }
#endif
...
__Pyx_RefNannySetupContext("PyInit_Neural_Network", 0);
  ...
  if (__pyx_module_is_main_Neural_Network____init__) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_mstate_global->__pyx_kp_u_Neural_Network___init) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "Neural_Network")) {
      if (unlikely((PyDict_SetItemString(modules, "Neural_Network", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init Neural_Network", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init Neural_Network");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static const __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {__pyx_k_Neural_Network___init, sizeof(__pyx_k_Neural_Network___init), 0, 1, 0}, /* PyObject cname: __pyx_kp_u_Neural_Network___init */
